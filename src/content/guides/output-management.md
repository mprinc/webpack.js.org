...
The <span class='important'>manifest data can be extracted into a json file</span> for easy consumption using the [`WebpackManifestPlugin`](https://github.com/shellscape/webpack-manifest-plugin).
