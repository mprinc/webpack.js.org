...
So what about other assets like fonts? The <span class='definition'>Asset Modules will take any file you load through them and output it to your build directory</span>. This means we can use them for any kind of file, including fonts. Let's update our `webpack.config.js` to handle font files:
